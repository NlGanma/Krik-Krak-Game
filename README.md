...
Rendering uses static geometry batches and cached shadows, a mirror capped at ten updates per second, and adaptive pixel density. Run `node --test tests/movement.test.js` for the jump checks.
